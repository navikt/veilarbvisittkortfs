...
import { AvslutningStatus, Oppfolging } from '../types/oppfolging';
...
function hentInnstillingsHistorikk(fnr: string): string {
    return `${OPPFOLGING_BASE_URL}/oppfolging/innstillingsHistorikk?fnr=${fnr}`;
}
