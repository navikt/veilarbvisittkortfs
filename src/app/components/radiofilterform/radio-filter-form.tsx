...
function RadioFilterForm<T>(props: RadioFilterFormProps<T>) {
  const { data, createLabel, createValue, radioName, visLukkKnapp } = props;
  ...
  return (
    <div className="radio-filterform">
      ...
      <div className="knapperad">
        <Hovedknapp hidden={visLukkKnapp && !props.selected} htmlType="submit" disabled={!props.selected}>
          Velg
        </Hovedknapp>
        <Knapp htmlType="button" onClick={props.closeDropdown}>
          Lukk
        </Knapp>
      </div>
    </div>
