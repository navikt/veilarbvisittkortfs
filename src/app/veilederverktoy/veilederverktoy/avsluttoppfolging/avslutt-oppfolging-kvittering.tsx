...
type AvsluttOppfolgingKvitteringProps = StateProps & DispatchProps;

function AvsluttOppfolgingKvittering({navn, navigerTilbake}: AvsluttOppfolgingKvitteringProps) {
    return (
        <Modal
...
export default connect<StateProps, DispatchProps>(mapStateToProps, mapDispatchToProps)(AvsluttOppfolgingKvittering);