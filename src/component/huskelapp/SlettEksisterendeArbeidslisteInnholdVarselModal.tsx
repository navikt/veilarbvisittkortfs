...
export const SlettEksisterendeArbeidslisteInnholdVarselModal = ({onCloseRequest, isOpen}: Props) => {
    ...
    const { showErrorModal, showSpinnerModal } = useModalStore();
    ...
    const handleSlettArbeidsListe = () => {
        ...
        showSpinnerModal();
        slettArbeidsliste(brukerFnr).then(ifResponseHasData(setArbeidsliste)).then(onCloseRequest).catch(showErrorModal);
    }
    ...
    return (
        ...
        >
            ...
            <Modal.Body>
                Tittel, kommentar og frist slettes for denne brukeren.
            </Modal.Body>
            <Modal.Footer>
                <Button
                    variant="primary"
